...
def walkthrough(cli, project, repo, skills_root, python):
    ...
    replacements = {
        ...
        "<operationalized negative result; distinguish insufficient coverage or precision>": "Baseline minus candidate below +0.01 declines promotion for this fixture; no population inference.",
        ...
        "<opportunity, mechanism, performance or publication claim; target population>": "Check the retained synthetic comparison and native closure; no scientific target population.",
        "<original cases/clusters, coverage, arms and repeats; distinguish variants>": "One retained synthetic baseline/candidate pair; no sampled cases, repeats or variants.",
        "<decision-changing difference or uncertainty; for deterministic tests, required coverage>": "Exactly reproduce the -0.03 gain and compare it with the fixed +0.01 threshold; no sampling precision claim.",
        "<compatible pilot evidence or assumption range; miss risk, expected signal, paired/clustered power or supplied reproduction protocol, as applicable>": "Deterministic arithmetic on invented aggregates; one fixture exercises this workflow without establishing statistical power or scientific performance.",
        "<cases × arms × repeats and likely calls/runtime, including screening, fresh controls, retries and review>": "Two retained values, local arithmetic and structure checks, and fixture review; no model calls or training.",
        "<positive, negative and inconclusive outcomes; planned batches/analyses and budget stop; no automatic sample growth>": "The fixed gain threshold decides synthetic promotion only. Unresolved review prevents closure. Stop after the declared local checks; no sample growth.",
    ...
    fields = {
        ...
        "Actual scale and coverage": "One of one retained synthetic pairs completed, with two arms and no repeats or missing outcomes.",
        "Scale adequacy": "Covers deterministic arithmetic and the native acceptance path only; no population uncertainty or scientific scale claim.",
