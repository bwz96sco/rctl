...
7. Local release tests cover macOS arm64 with CPython 3.11.11 and 3.13.2. Public [GitHub CI](https://github.com/bwz96sco/rctl/actions/runs/34024998318) also passed all four macOS/Linux × Python 3.11/3.13 jobs, including 140 tests per job, lint, document checks, build, and installed-wheel smoke. Other native operating systems are rejected; WSL execution has not been tested. Publication was explicitly authorized; host/global configuration was not changed.
