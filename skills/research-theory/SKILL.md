...
- Route prior-theorem and citation work to `research-literature`, manuscript integration to `research-writing`, and numerical counterexample checks to `research-computation` when needed. Small direct checks may stay inline; formal comparative experiments belong to `research-experiment`.
