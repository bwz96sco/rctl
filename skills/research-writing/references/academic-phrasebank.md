...
- **Directly established within the stated scope:** show, demonstrate, establish, identify; 表明、确立、识别. A single well-supported measurement or valid proof can justify a precise bounded statement; broader generalization needs its own evidence.
- **Supported interpretation with unresolved alternatives:** suggest, indicate, support the view that, be consistent with; 提示、支持……的看法、与……一致. State the relevant design limitation or alternative explanation.
- **Hypothesis or extrapolation beyond observation:** may, might, could, may reflect, could arise from; 可能、或可解释为. Name the inferential step instead of assigning confidence from the number of studies.
- **Evidence unavailable:** this has not been established by the available evidence; the present analysis does not determine ...; 现有证据尚不能确定……. Missing evidence alone does not show that a question is unstudied or open across the field.

Calibrate to design, measurement, uncertainty, and claim scope, not study counts. A literature-absence statement such as "we found no study examining X" requires an actual search with its corpus, coverage, and date stated or linked; "to our knowledge" is not a substitute.
