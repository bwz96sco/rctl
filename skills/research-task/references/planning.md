...
short sentence per relationship field. If alignment adequacy affects closure,
declare a review criterion citing the governing source and result through the
task-relative evidence convention. The declaration is part of the agreement;
structural validation does not judge its scientific adequacy.
